...
//                log.info("针对半连接做重试");
    ...
    private static void setCustomUserAgent(String customUserAgent) {
     ...
     * @return
     */
    private static Map<String, String> splitKeyValuePairString(String queryString, String segmentSeparator, String keyValueSeparator) {
     ...
     * @return
     */
    private static Map<String, String> splitKeyValuePairString(String queryString) {
    ...
    public static String executeRequest(HttpUriRequest request, int timeout, String defaultCharset) {
        ...
        try {
            ...
            if(e instanceof SocketTimeoutException) {
                throw new HahahaHttpException();
            }else if(e instanceof HahahaHttpException) {
                throw (HahahaHttpException)e;
            }else {
...
//            log.error("Encoding Error: url={}, error={}", url, e.getMessage());
    ...
    public static class HahahaHttpException extends RuntimeException{
        //TODO 需要细分
    }
